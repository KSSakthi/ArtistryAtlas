...
<body>
    ...
    <main>
        ...
        <div class="container">
          ...
          <span>Digital art: where pixels become poetry, and the screen is our canvas for boundless expression</span>
<p>Digital art is a form of artistic expression created using digital technology, such as computers, tablets, and specialized software. Unlike traditional art mediums like paint or charcoal, digital art is produced entirely in the digital realm, using tools and techniques that simulate traditional artistic processes or explore entirely new possibilities.</p>        
<p>Digital artists use a variety of software programs and applications, such as Adobe Photoshop, Corel Painter, and Procreate, to create their artwork. These programs offer a wide range of tools and features, including brushes, layers, filters, and editing capabilities, allowing artists to manipulate images, create intricate designs, and experiment with different styles and techniques.</p>
       <p>One of the key advantages of digital art is its versatility and flexibility. Artists can easily modify and manipulate their artwork, undo mistakes, and experiment with different colors, textures, and compositions without the constraints of traditional mediums. This allows for a greater degree of creative exploration and iteration, as well as the ability to produce high-quality digital artwork that can be easily shared and distributed online.</p> 
        <!-- <p>Paragraph</p>
            <p class="meh">meh</p> -->
        </article>
        </div>
        <p style="padding-left: 100px;padding-right: 100px;font-family: 'PT Sans';font-weight: 400;font-size: 1.150em;line-height: 1.4;">Digital art encompasses a wide range of styles and genres, including digital painting, illustration, graphic design, 3D modeling, animation, and digital photography. From hyper-realistic portraits and landscapes to abstract compositions and fantastical worlds, digital art offers endless possibilities for artistic expression and experimentation.</p><br>
       <p style="padding-left: 100px;padding-right: 100px;font-family: 'PT Sans';font-weight: 400;font-size: 1.150em;line-height: 1.4;">Furthermore, digital art has become increasingly accessible to artists of all skill levels, thanks to the proliferation of affordable digital tools and resources. Whether creating artwork for personal enjoyment, professional projects, or commercial purposes, digital artists can leverage technology to bring their creative visions to life with precision and polish.</p><br>
   <p style="padding-left: 100px;padding-right: 100px;font-family: 'PT Sans';font-weight: 400;font-size: 1.150em;line-height: 1.4;">In summary, digital art represents a dynamic and evolving form of artistic expression that harnesses the power of technology to create captivating and immersive visual experiences. It blurs the boundaries between traditional and digital mediums, offering artists new avenues for creativity, innovation, and self-expression in the digital age.</p><br>
