...
<body>
    <div class='dashboard'>
        <div class="dashboard-nav">
            ...
            <div class="row it">
            <h2 style="display:flex; color:#10188d;justify-content: center; font-family: fangsong; font-weight:bold; padding-bottom :20px;">POST TIPS</h2>
    ...
    <div class="form-group">
        ...
        <select id="tipCategory" name="tipCategory" required>
    ...
    <div class="form-group">
        ...
        <textarea id="tipInstructions" name="tipInstructions" rows="4" required></textarea>
    </div>

    <div class="form-group">
        <label for="tipToolsUsed">Tools Used:</label>
        <input type="text" id="tipToolsUsed" name="tipToolsUsed" required>
    </div>

    <div class="form-group">
        <label for="tipPdf">Tips Pdf:</label>
        <input type="file" id="tipPdf" name="tipPdf" accept=".pdf" required>
    </div>
