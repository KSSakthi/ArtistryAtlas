...
<div class='dashboard'>
        ...
        <div class='dashboard-app'>
            ...
            <div class="row it">
            <h2 style="display:flex; color:#10188d;justify-content: center; font-family: fangsong; font-weight:bold; padding-bottom :20px;">POST TUTORIAL</h2>
                <div class="col-sm-offset-1 col-sm-10" id="one">
                    
        <form action="{{ route('post.tutorial') }}" method="post" enctype="multipart/form-data">
        @csrf
