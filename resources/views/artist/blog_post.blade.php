...
<div class='dashboard'>
    ...
    <div class='dashboard-app'>
            ...
            <div class="row it">
            <h2 style="display:flex; color:#10188d;justify-content: center; font-family: fangsong; font-weight:bold; padding-bottom :20px;">POST BLOG</h2>
        ...
        <div class="form-group">
            ...
            <input type="file" id="artworkImages" name="artworkImages" accept="image/*" required>
        </div>
            <div class="form-group">
                <label for="blogContent">Blog Content:</label>
                <textarea id="blogContent" name="blogContent" rows="13" required></textarea>
            </div>
