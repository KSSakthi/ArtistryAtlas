...
<body>
    <div class='dashboard'>
        ...
        <div class='dashboard-app'>
            ...
            font-size: 30px;
            font-weight: 600;">Previous Transactions</h2>
        ...
        <td>
            ...
            <form action="{{ route('process.payment', ['transaction' => $transaction->id]) }}" method="post">
                ...
                <script src="https://checkout.razorpay.com/v1/checkout.js"
                    ...
                    data-name="Artist Atlas"
                    data-description="Product: Customize Art"
                    data-image="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/razorpay-icon.png"
                    data-prefill.name="{{ $transaction->sender->name }}"
                    data-prefill.email="{{ $transaction->sender->email }}">
                </script>
            </form>
            @endif
        </td>
