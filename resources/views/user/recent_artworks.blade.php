...
<head>
    ...
    <title>User - Recent Artworks</title>
...
<body>
    <div class='dashboard'>
        ...
        <div class='dashboard-app'>
            ...
            <div class='container'>
    <h2 class="recent">RECENT ARTWORKS</h2>

    <div class="gallery">
        @foreach ($recentArtworks as $artwork)
        <div class="artwork">
            <h3 style="color: #a51da4;font-family: emoji;font-size: 22px;font-weight: 600;">{{ $artwork->art_title }}</h3>
