...
<head>
    ...
    <title>User - All Tutorials</title>
...
<body>
    <div class='dashboard'>
        ...
        <div class='dashboard-app'>
            ...
            <br><h2 style="color:#9d2b25;text-align: center; font-family: fangsong; font-weight:bold;">ALL TUTORIALS</h2>
            <div class="gallery">
@foreach ($tutorials as $tutorial)
    <div class="tutorial">
        <h2 style="font-family: fangsong;color: #2e739f;">{{ $tutorial->title }}</h2>
        <p><strong style="color: #581497;font-family: emoji;font-size: 19px;">Author:</strong><span style="color: #936f11;font-family: emoji;font-size: 20px;"> {{ $tutorial->user->name }}</span></p>
        <video controls>
        <source src="{{ asset('storage/' . $tutorial->video_path) }}" type="video/mp4">
            Your browser does not support the video tag.
        </video>
        <p><strong  style="color: #5a1389;font-family: math;font-size: 18px;">Description:</strong> <span>{{ $tutorial->description }}</span></p>
        <p style="color: #898586;font-family: auto;font-size: 15px;">Uploaded At: {{ $tutorial->created_at }}</p>
    </div>
@endforeach
