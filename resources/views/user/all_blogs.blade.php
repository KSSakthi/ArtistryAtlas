...
<body>
    <div class='dashboard'>
        ...
        <div class='dashboard-app'>
            ...
            <br><h2 style="color:#9d2b25;text-align: center; font-family: fangsong; font-weight:bold;">ALL BLOGS</h2><br>
            <div class="gallery" style="padding-left: 50px;padding-right:20px;">
    @foreach ($allBlogs as $blog)
        <div class="blog-post">
            ...
            <div class="blog-post-content">
                ...
                <p class="created-at"><strong>Created At:</strong> {{ $blog->created_at }}</p>
